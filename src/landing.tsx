        ...
        <section id="home" className='w-screen h-screen'>
            <nav className="w-screen h-[10vh] flex px-[150px] py-[50px]">
                ...
                <div className='flex flex-row px-[100px]'>
                    <Button variant="link" className='text-lg font-semibold'>  <a href="#home">Acasă</a> </Button>
                    ...
                    <Button variant="link" className='text-lg font-semibold'><a href="#echipa">Echipa</a> </Button>
                </div>
            </nav >
            <main className='flex justify-center items-center flex-col w-[100vw] h-[90vh]'>
                ...
                {/* <MarqueeAnimation baseVelocity={-3} classNameParent='relative bg-gray-500 z-20 -top-[200px]'>
                ...
                <MarqueeAnimation baseVelocity={-2.5} classNameParent='relative bg-neutral-950 h-20 flex items-center z-0 -top-[200px]'>
                    <span className='flex justify-center items-center gap-4'>
                        {coffees.map((coffee) => <span className='flex items-center gap-4  text-amber-500'><Star fill='white' stroke='white' />{coffee}</span>)}
                    </span>
                </MarqueeAnimation>
                <Button className='h-20 w-[20vw] rounded-full bg-neutral-800 text-2xl font-semibold'>Intră în aplicație</Button>
                <Button className="absolute right-10 bottom-10 rounded-full w-20 h-20">
